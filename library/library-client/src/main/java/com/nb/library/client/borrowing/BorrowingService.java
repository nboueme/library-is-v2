 ...
 * 
 */
@WebServiceClient(name = "BorrowingService", targetNamespace = "borrowing.client.library.nb.com", wsdlLocation = "http://localhost:8081/library/BorrowingService?wsdl")
    ...
    extends Service
{
    ...
    static {
        ...
        try {
            url = new URL("http://localhost:8081/library/BorrowingService?wsdl");

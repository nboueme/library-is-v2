 ...
 * 
 */
@WebServiceClient(name = "ReservationService", targetNamespace = "reservation.client.library.nb.com", wsdlLocation = "http://web-service:8080/library/ReservationService?wsdl")
    ...
    extends Service
{
    ...
    private final static QName RESERVATIONSERVICE_QNAME = new QName("reservation.client.library.nb.com", "ReservationService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://web-service:8080/library/ReservationService?wsdl");
    ...
    public ReservationClient getReservationPort() {
        return super.getPort(new QName("reservation.client.library.nb.com", "ReservationPort"), ReservationClient.class);
    }
    ...
    public ReservationClient getReservationPort(WebServiceFeature... features) {
        return super.getPort(new QName("reservation.client.library.nb.com", "ReservationPort"), ReservationClient.class, features);
    }

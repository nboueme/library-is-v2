 ...
 * 
 */
@WebServiceClient(name = "UserService", targetNamespace = "user.client.library.nb.com", wsdlLocation = "http://192.168.0.23:8081/library/UserService?wsdl")
    ...
    extends Service
{
    ...
    private final static QName USERSERVICE_QNAME = new QName("user.client.library.nb.com", "UserService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://192.168.0.23:8081/library/UserService?wsdl");
    ...
    public UserClient getUserPort() {
        return super.getPort(new QName("user.client.library.nb.com", "UserPort"), UserClient.class);
    }
    ...
    public UserClient getUserPort(WebServiceFeature... features) {
        return super.getPort(new QName("user.client.library.nb.com", "UserPort"), UserClient.class, features);
    }

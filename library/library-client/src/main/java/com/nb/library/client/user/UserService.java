 ...
 * 
 */
@WebServiceClient(name = "UserService", targetNamespace = "user.client.library.nb.com", wsdlLocation = "http://localhost:8081/library/UserService?wsdl")
    ...
    extends Service
{
    ...
    static {
        ...
        try {
            url = new URL("http://localhost:8081/library/UserService?wsdl");

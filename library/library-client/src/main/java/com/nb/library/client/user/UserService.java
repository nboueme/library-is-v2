 ...
 * 
 */
@WebServiceClient(name = "UserService", targetNamespace = "user.client.library.nb.com", wsdlLocation = "http://web-service:8080/library/UserService?wsdl")
    ...
    extends Service
{
    ...
    static {
        ...
        try {
            url = new URL("http://web-service:8080/library/UserService?wsdl");

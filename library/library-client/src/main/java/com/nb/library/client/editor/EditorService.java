 ...
 * 
 */
@WebServiceClient(name = "EditorService", targetNamespace = "editor.client.library.nb.com", wsdlLocation = "http://localhost:8081/library/EditorService?wsdl")
    ...
    extends Service
{
    ...
    static {
        ...
        try {
            url = new URL("http://localhost:8081/library/EditorService?wsdl");

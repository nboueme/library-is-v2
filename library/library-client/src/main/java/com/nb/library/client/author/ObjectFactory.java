 ...
 * generated in the com.nb.library.client.author package. 
...
public class ObjectFactory {
    ...
    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: com.nb.library.client.author
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "author.client.library.nb.com", name = "getAuthorResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "author.client.library.nb.com", name = "listAuthors")
     ...
     * 
     */
    @XmlElementDecl(namespace = "author.client.library.nb.com", name = "listAuthorsResponse")

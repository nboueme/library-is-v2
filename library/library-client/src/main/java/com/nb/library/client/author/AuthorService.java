 ...
 * 
 */
@WebServiceClient(name = "AuthorService", targetNamespace = "author.client.library.nb.com", wsdlLocation = "http://192.168.0.23:8081/library/AuthorService?wsdl")
    ...
    extends Service
{
    ...
    private final static QName AUTHORSERVICE_QNAME = new QName("author.client.library.nb.com", "AuthorService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://192.168.0.23:8081/library/AuthorService?wsdl");
    ...
    public AuthorClient getAuthorPort() {
        return super.getPort(new QName("author.client.library.nb.com", "AuthorPort"), AuthorClient.class);
    }
    ...
    public AuthorClient getAuthorPort(WebServiceFeature... features) {
        return super.getPort(new QName("author.client.library.nb.com", "AuthorPort"), AuthorClient.class, features);
    }

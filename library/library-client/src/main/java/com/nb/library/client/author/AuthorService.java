 ...
 * 
 */
@WebServiceClient(name = "AuthorService", targetNamespace = "author.client.library.nb.com", wsdlLocation = "http://localhost:8081/library/AuthorService?wsdl")
    ...
    extends Service
{
    ...
    static {
        ...
        try {
            url = new URL("http://localhost:8081/library/AuthorService?wsdl");

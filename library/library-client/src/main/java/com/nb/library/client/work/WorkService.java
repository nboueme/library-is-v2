 ...
 * 
 */
@WebServiceClient(name = "WorkService", targetNamespace = "work.client.library.nb.com", wsdlLocation = "http://web-service:8080/library/WorkService?wsdl")
    ...
    extends Service
{
    ...
    static {
        ...
        try {
            url = new URL("http://web-service:8080/library/WorkService?wsdl");

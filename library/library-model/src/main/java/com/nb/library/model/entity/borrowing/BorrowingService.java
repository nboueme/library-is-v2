 ...
 * 
 */
@WebServiceClient(name = "BorrowingService", targetNamespace = "borrowing.entity.model.library.nb.com", wsdlLocation = "http://localhost:8080/library/BorrowingService?wsdl")
    ...
    extends Service
{
    ...
    private final static QName BORROWINGSERVICE_QNAME = new QName("borrowing.entity.model.library.nb.com", "BorrowingService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:8080/library/BorrowingService?wsdl");
    ...
    public BorrowingClient getBorrowingPort() {
        return super.getPort(new QName("borrowing.entity.model.library.nb.com", "BorrowingPort"), BorrowingClient.class);
    }
    ...
    public BorrowingClient getBorrowingPort(WebServiceFeature... features) {
        return super.getPort(new QName("borrowing.entity.model.library.nb.com", "BorrowingPort"), BorrowingClient.class, features);
    }

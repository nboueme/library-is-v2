 ...
 * generated in the com.nb.library.model.entity.type package. 
...
public class ObjectFactory {
    ...
    private final static QName _ListTypesWorks_QNAME = new QName("type.entity.model.library.nb.com", "listTypesWorks");
    private final static QName _GetTypeWork_QNAME = new QName("type.entity.model.library.nb.com", "getTypeWork");
    private final static QName _GetTypeWorkResponse_QNAME = new QName("type.entity.model.library.nb.com", "getTypeWorkResponse");
    private final static QName _ListTypesWorksResponse_QNAME = new QName("type.entity.model.library.nb.com", "listTypesWorksResponse");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: com.nb.library.model.entity.type
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "type.entity.model.library.nb.com", name = "listTypesWorks")
     ...
     * 
     */
    @XmlElementDecl(namespace = "type.entity.model.library.nb.com", name = "getTypeWork")
     ...
     * 
     */
    @XmlElementDecl(namespace = "type.entity.model.library.nb.com", name = "getTypeWorkResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "type.entity.model.library.nb.com", name = "listTypesWorksResponse")

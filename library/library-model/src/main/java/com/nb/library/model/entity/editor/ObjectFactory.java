 ...
 * generated in the com.nb.library.model.entity.editor package. 
...
public class ObjectFactory {
    ...
    private final static QName _ListEditors_QNAME = new QName("editor.entity.model.library.nb.com", "listEditors");
    private final static QName _ListEditorsResponse_QNAME = new QName("editor.entity.model.library.nb.com", "listEditorsResponse");
    private final static QName _GetEditor_QNAME = new QName("editor.entity.model.library.nb.com", "getEditor");
    private final static QName _GetEditorResponse_QNAME = new QName("editor.entity.model.library.nb.com", "getEditorResponse");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: com.nb.library.model.entity.editor
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "editor.entity.model.library.nb.com", name = "listEditors")
     ...
     * 
     */
    @XmlElementDecl(namespace = "editor.entity.model.library.nb.com", name = "listEditorsResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "editor.entity.model.library.nb.com", name = "getEditor")
     ...
     * 
     */
    @XmlElementDecl(namespace = "editor.entity.model.library.nb.com", name = "getEditorResponse")

 ...
 * 
 */
@WebServiceClient(name = "EditorService", targetNamespace = "editor.entity.model.library.nb.com", wsdlLocation = "http://localhost:8080/library/EditorService?wsdl")
    ...
    extends Service
{
    ...
    private final static QName EDITORSERVICE_QNAME = new QName("editor.entity.model.library.nb.com", "EditorService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:8080/library/EditorService?wsdl");
    ...
    public EditorClient getEditorPort() {
        return super.getPort(new QName("editor.entity.model.library.nb.com", "EditorPort"), EditorClient.class);
    }
    ...
    public EditorClient getEditorPort(WebServiceFeature... features) {
        return super.getPort(new QName("editor.entity.model.library.nb.com", "EditorPort"), EditorClient.class, features);
    }

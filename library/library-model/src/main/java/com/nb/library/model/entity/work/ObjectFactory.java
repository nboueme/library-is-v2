 ...
 * generated in the com.nb.library.model.entity.work package. 
...
public class ObjectFactory {
    ...
    private final static QName _GetWorkResponse_QNAME = new QName("work.entity.model.library.nb.com", "getWorkResponse");
    private final static QName _GetWork_QNAME = new QName("work.entity.model.library.nb.com", "getWork");
    private final static QName _ListWorksResponse_QNAME = new QName("work.entity.model.library.nb.com", "listWorksResponse");
    private final static QName _ListWorks_QNAME = new QName("work.entity.model.library.nb.com", "listWorks");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: com.nb.library.model.entity.work
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "work.entity.model.library.nb.com", name = "getWorkResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "work.entity.model.library.nb.com", name = "getWork")
     ...
     * 
     */
    @XmlElementDecl(namespace = "work.entity.model.library.nb.com", name = "listWorksResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "work.entity.model.library.nb.com", name = "listWorks")
